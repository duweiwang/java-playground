package com.wangduwei.asm.demo2;
...
public class TestMonitor extends ClassLoader {
    ...
    public static void main(String[] args) throws IOException, NoSuchMethodException, IllegalAccessException, InstantiationException, InvocationTargetException {
        ...
        {
            MethodVisitor methodVisitor = cw.visitMethod(Opcodes.ACC_PUBLIC,
                    "<init>", "()V", null, null);
        ...
        Class<?> clazz = new TestMonitor().defineClass("com.wangduwei.asm.demo2.MyMethod", bytes, 0, bytes.length);
