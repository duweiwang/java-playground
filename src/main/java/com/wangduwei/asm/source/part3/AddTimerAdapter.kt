package com.wangduwei.asm.source.part3
...
fun main() {
    val classReader = ClassReader("com.wangduwei.asm.source.part3.AddTimerAdapter")
    ...
    val loader = MyLoader()
    val addTimerAdapterClazz = loader.defineClass("com.wangduwei.asm.source.part3.AddTimerAdapter", classWriter.toByteArray())
    // 获取 addTimer 方法
