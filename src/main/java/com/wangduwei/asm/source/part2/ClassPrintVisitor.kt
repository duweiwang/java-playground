...
import com.wangduwei.asm.source.part2.MyModuleVisitor
...
class ClassPrintVisitor(version: Int) : ClassVisitor(version) {
    ...
    override fun visitInnerClass(
        ...
        ADLog.info(
            "visitInnerClass:name=$name,outerName=$outerName,innerName:$innerName,access=${
                AccessCodeUtils.accCode2String(
                access
            )}"
        )
