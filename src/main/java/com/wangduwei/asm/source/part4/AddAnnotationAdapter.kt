...
fun main() {
    val classReader = ClassReader("com.wangduwei.asm.source.part4.AddAnnotationAdapter")
    ...
    val classAdapter = loadClass.defineClass("com.wangduwei.asm.source.part4.AddAnnotationAdapter",classWriter.toByteArray())
