...
import com.wangduwei.asm.source.part3.MyLoader
import com.wangduwei.asm.source.part6.ClassTransformer
...
fun main() {
    ...
    val classReader = ClassReader("com.wangduwei.asm.source.part7.AddTimerMethodTree")
    ...
    val loader = MyLoader()
    val addTimerAdapterClazz = loader.defineClass("com.wangduwei.asm.source.part7.AddTimerMethodTree", classWriter.toByteArray())
    // 获取 addTimer 方法
