...
/**
 * @author 杜伟
 * @date 2021/8/6 8:26 PM
 *
 * 生成一个class文件，反射调用，输出一段文字
 *
 * 用于练习ASM生成类文件
 *
 * 运行通过
...
public class HelloWord extends ClassLoader {
    ...
    public static void main(String[] args) throws Exception{
        ...
        outputClazz(bytes);
        // 加载AsmHelloWorld
        Class<?> clazz = new HelloWord().defineClass("org.itstack.demo.asm.AsmHelloWorld", bytes, 0, bytes.length);
        // 反射获取 main 方法
    ...
    private static void outputClazz(byte[] bytes) {
        ...
        try {
            String pathName = HelloWord.class.getResource("/").getPath() + "AsmHelloWorld.class";
